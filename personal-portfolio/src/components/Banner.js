            ...
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h2> <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Software Engineer!", "AI Engineer!", "Data Wizard!" ]'><span className="wrap">{text}</span></span></h2>
                  <p>Looking for a Senior Software Engineer and AI expert who can transform your tech vision into reality? With a dynamic blend of advanced frontend and backend skills, I specialize in building high-performance large scale distributed systems and seamless user experiences. From crafting interactive interfaces with React and Next.js to architecting scalable, robust backend solutions using Java, Spring Boot, Django, and microservices, I ensure every project is built to perform. My cloud expertise with AWS, GCP, and Azure empowers me to design efficient, real-time data pipelines, while tools like Apache Kafka, Apache Spark, and Airflow allow me to automate and optimize complex workflows. I’m here to help you take your technology to the next level!</p>
